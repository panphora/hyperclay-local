...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.13.3-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.13.3-arm64.dmg) (101.6MB)
   - **macOS (Intel)**: [HyperclayLocal-1.13.3.dmg](https://local.hyperclay.com/HyperclayLocal-1.13.3.dmg) (109.3MB)
   - **Windows**: [HyperclayLocal-Setup-1.13.3.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.13.3.exe) (~81.9MB)
   - **Linux**: [HyperclayLocal-1.13.3.AppImage](https://local.hyperclay.com/HyperclayLocal-1.13.3.AppImage) (119.9MB)
