...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.16.0-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.16.0-arm64.dmg) (101.6MB)
   - **macOS (Intel)**: [HyperclayLocal-1.16.0.dmg](https://local.hyperclay.com/HyperclayLocal-1.16.0.dmg) (109.3MB)
   - **Windows**: [HyperclayLocal-Setup-1.16.0.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.16.0.exe) (~81.9MB)
   - **Linux**: [HyperclayLocal-1.16.0.AppImage](https://local.hyperclay.com/HyperclayLocal-1.16.0.AppImage) (119.9MB)
