...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.22.2-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.22.2-arm64.dmg) (103.1MB)
   - **macOS (Intel)**: [HyperclayLocal-1.22.2.dmg](https://local.hyperclay.com/HyperclayLocal-1.22.2.dmg) (109.6MB)
   - **Windows**: [HyperclayLocal-Setup-1.22.2.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.22.2.exe) (90.4MB)
   - **Linux**: [HyperclayLocal-1.22.2.AppImage](https://local.hyperclay.com/HyperclayLocal-1.22.2.AppImage) (123.8MB)
