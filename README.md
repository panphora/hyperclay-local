...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.19.1-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.19.1-arm64.dmg) (101.8MB)
   - **macOS (Intel)**: [HyperclayLocal-1.19.1.dmg](https://local.hyperclay.com/HyperclayLocal-1.19.1.dmg) (109.5MB)
   - **Windows**: [HyperclayLocal-Setup-1.19.1.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.19.1.exe) (90.0MB)
   - **Linux**: [HyperclayLocal-1.19.1.AppImage](https://local.hyperclay.com/HyperclayLocal-1.19.1.AppImage) (120.2MB)
