...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.6.0-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.6.0-arm64.dmg) (100.3MB)
   - **macOS (Intel)**: [HyperclayLocal-1.6.0.dmg](https://local.hyperclay.com/HyperclayLocal-1.6.0.dmg) (108.0MB)
   - **Windows**: [HyperclayLocal-Setup-1.6.0.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.6.0.exe) (~81.0MB)
   - **Linux**: [HyperclayLocal-1.6.0.AppImage](https://local.hyperclay.com/HyperclayLocal-1.6.0.AppImage) (118.6MB)
