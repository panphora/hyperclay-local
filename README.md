...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.23.3-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.23.3-arm64.dmg) (102.0MB)
   ...
   - **Linux (ARM64)**: [HyperclayLocal-1.23.3-arm64.AppImage](https://local.hyperclay.com/HyperclayLocal-1.23.3-arm64.AppImage) (123.1MB)
