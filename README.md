...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.23.1-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.23.1-arm64.dmg) (101.9MB)
   - **macOS (Intel)**: [HyperclayLocal-1.23.1.dmg](https://local.hyperclay.com/HyperclayLocal-1.23.1.dmg) (108.5MB)
   - **Windows**: [HyperclayLocal-Setup-1.23.1.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.23.1.exe) (89.9MB)
   - **Linux (x86_64)**: [HyperclayLocal-1.23.1.AppImage](https://local.hyperclay.com/HyperclayLocal-1.23.1.AppImage) (123.3MB)
   - **Linux (ARM64)**: [HyperclayLocal-1.23.1-arm64.AppImage](https://local.hyperclay.com/HyperclayLocal-1.23.1-arm64.AppImage) (123.0MB)
