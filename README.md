...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.2.1-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.2.1-arm64.dmg) (107.3MB)
   - **macOS (Intel)**: [HyperclayLocal-1.2.1.dmg](https://local.hyperclay.com/HyperclayLocal-1.2.1.dmg) (114.9MB)
   - **Windows**: [HyperclayLocal-Setup-1.2.1.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.2.1.exe) (86.1MB)
   - **Linux**: [HyperclayLocal-1.2.1.AppImage](https://local.hyperclay.com/HyperclayLocal-1.2.1.AppImage) (114.1MB)
