...
1. **Download** the app for your platform:
   - **macOS (Apple Silicon)**: [HyperclayLocal-1.4.0-arm64.dmg](https://local.hyperclay.com/HyperclayLocal-1.4.0-arm64.dmg) (110.5MB)
   - **macOS (Intel)**: [HyperclayLocal-1.4.0.dmg](https://local.hyperclay.com/HyperclayLocal-1.4.0.dmg) (118.1MB)
   - **Windows**: [HyperclayLocal-Setup-1.4.0.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.4.0.exe) (~88.6MB)
   - **Linux**: [HyperclayLocal-1.4.0.AppImage](https://local.hyperclay.com/HyperclayLocal-1.4.0.AppImage) (117.3MB)
