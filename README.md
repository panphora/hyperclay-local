...
1. **Download** the app for your platform:
   ...
   - **Windows**: [HyperclayLocal-Setup-1.16.0.exe](https://local.hyperclay.com/HyperclayLocal-Setup-1.16.0.exe) (~82.0MB)
   - **Linux**: [HyperclayLocal-1.16.0.AppImage](https://local.hyperclay.com/HyperclayLocal-1.16.0.AppImage) (120.0MB)
